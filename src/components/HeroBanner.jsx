...
import RESUME_ASHPREET_KAUR from '../assets/RESUME_ASHPREET_KAUR.pdf';
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>ashpreet.kaur2025@gmail.com</div>
                    </div>
                ...
                {/* INTRO START */}
                {/* <motion.div
                    className="flex flex-col mb-10 text-center md:text-center text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] relative"
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">A lifelong leaner</span>
                    </div>
                    <div className="max-w-[510px]">
                        I am currently a student pursuing B.Tech.
                    </div>
                </motion.div> */}
                {/* INTRO END */}
                ...
                >
                    ...
                    <div
                        className="absolute top-[420px] -right-100 2xl:top-[140px] 2xl:-right-15 w-[240px] h-[140px] rounded-full bg-white/[0.9] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick= {()=>
                         <a
                            href={RESUME_ASHPREET_KAUR}
                            // download="RESUME_ASHPREET_KAUR"
                            target="_blank"
                    ...
                    >
                        <img
                            ...
                            className="w-[15px]"
                        />
                        <div className="text-black">Download Resume
