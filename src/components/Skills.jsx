...
const Skills = () => {
    ...
    return (
        ...
        >
            ...
            <Wrapper>
                {/* SKILL ICONS START */}
                <Div className="grid grid-cols-7 gap-4 md:grid-cols-13 relative">
                    <SkillIcon path={sk1} />
                    <SkillIcon path={sk2} />
                    {/* <SkillIcon path={sk3} />
                    <SkillIcon path={sk4} /> */}
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="I am proficient in developing and deploying machine learning models, with expertise in data preprocessing, feature engineering, and model selection. Additionally, I have a strong grasp of deep learning techniques and frameworks, enabling me to tackle complex tasks with precision. My skill set encompasses a wide range of algorithms and tools, allowing me to solve diverse real-world problems through data-driven solutions."
                           
                        />
                        <Service
                            num="2"
                            title="Web Development"
                            desc="I specialize in crafting responsive and visually appealing web applications. Moreover, I excel in harnessing the power of React, delivering dynamic and interactive user interfaces. My skill set empowers me to create seamless, user-centric web experiences that engage and captivate audiences."
